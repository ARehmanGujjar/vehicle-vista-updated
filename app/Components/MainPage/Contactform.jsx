...
const ContacthtmlForm = () => {
  return (
    <>
    <div className="max-w-screen-lg mx-auto p-5 rounded-lg">
    <div className="grid grid-cols-1 md:grid-cols-12 border rounded-lg">
        <div className="bg-[#8ca1e6] md:col-span-4 p-10 text-white">
            <p className="mt-4 text-sm leading-7 font-regular uppercase">
                Contact
            </p>
            <h3 className="text-3xl sm:text-4xl leading-normal font-extrabold tracking-tight">
                Get In <span className="text-[#071952]">Touch</span>
            </h3>
            <p className="mt-4 leading-7 text-gray-200">
                Thank you for Contacting Us at vehicleVista, We will contact you soon, Stay Tuned!
            </p>

            <div className="flex items-center mt-5">
                <svg className="h-6 mr-2 text-[#071952]" fill="currentColor" version="1.1"
        ...
        <form className="md:col-span-8 p-10">
            ...
            <div className="flex flex-wrap -mx-3 mb-6">
                ...
                <div className="flex justify-between w-full px-3">
                    ...
                    <button
                        className="bg-[#071952] hover:outline hover:outline-2 hover:outline-[#071952] rounded-lg text-white p-2 hover:bg-white hover:text-[#071952]"
                        type="submit">
                        Send Message
                    </button>
                </div>
