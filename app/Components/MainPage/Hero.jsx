  ...
  <div className="container mx-auto flex px-5 py-16 sm:py-24 md:flex-row flex-col items-center">
    <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
      ...
      <div className="flex justify-center">
        <Link href='/vehiclevista-user'><button className="inline-flex hover:text-white text-[#071952]  py-2 px-6 outline outline-2 outline-[#071952] hover:bg-[#071952] rounded text-lg
